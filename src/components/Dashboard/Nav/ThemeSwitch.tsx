...
const ThemeSwitch = ({ className }: ThemeSwitchProps) => {
  ...
  return (
    <div
      className={twMerge(
        "mx-3 px-5 py-4 rounded-md flex justify-center gap-x-6 items-center bg-kb-grey-light-secondary dark:bg-kb-black-secondary",
        className
      )}
    >
      ...
      >
        <Switch.Thumb className="SwitchThumb w-[14px] h-[14px] bg-white rounded-full will-change-transform block transition-transform duration-100 translate-x-0.5 data-[state=checked]:translate-x-[23px]" />
      </Switch.Root>
