            ...
            <Modal onInteractOutside={() => router.back()}>
                <div className="space-y-6">
                    <div className="flex justify-between items-start">
                        <Modal.Title className="heading-lg text-kb-black-primary dark:text-white w-4/5 max-w-sm">
                            Research pricing points of various competitors and
                            trial different business models
                        </Modal.Title>
                    ...
                    <p className="copy-lg text-kb-grey-dark-secondary">
                        ...
                        Now we need to finalise the first pricing model we'll
                        use. Keep iterating the subtasks until we have a
